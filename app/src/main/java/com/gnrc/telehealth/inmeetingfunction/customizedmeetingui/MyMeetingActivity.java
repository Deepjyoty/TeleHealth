...
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.audio.MeetingAudioCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.audio.MeetingAudioHelper;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.bo.BOEventCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.other.MeetingCommonCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.share.MeetingShareCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.share.MeetingShareHelper;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.user.MeetingUserCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.video.MeetingVideoCallback;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.video.MeetingVideoHelper;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.MeetingOptionBar;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.MeetingWindowHelper;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.RealNameAuthDialog;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.share.AnnotateToolbar;
import com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.share.CustomShareView;
import com.gnrc.telehealth.inmeetingfunction.livetranscription.LiveTranscriptionRequestHandleDialog;
import com.gnrc.telehealth.ui.APIUserStartJoinMeetingActivity;
import com.gnrc.telehealth.ui.BreakoutRoomsAdminActivity;
import com.gnrc.telehealth.ui.InitAuthSDKActivity;
import com.gnrc.telehealth.ui.LoginUserStartJoinMeetingActivity;
import com.gnrc.telehealth.ui.UIUtil;
    ...
    MeetingAudioHelper.AudioCallBack audioCallBack = new MeetingAudioHelper.AudioCallBack() {
        ...
        public boolean requestAudioPermission() {
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MyMeetingActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_AUDIO_CODE);
                return false;
            }
            return true;
        }
    ...
    MeetingShareHelper.MeetingShareUICallBack shareCallBack = new MeetingShareHelper.MeetingShareUICallBack() {
        ...
        public boolean requestStoragePermission() {
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MyMeetingActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_STORAGE_CODE);
                return false;
            }
            return true;
        }
