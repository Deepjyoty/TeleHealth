package com.gnrc.telehealth.inmeetingfunction.customizedmeetingui.view.share;
...
public class RCFloatView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mHelpDialog.setContentView(R.layout.zm_rc_fingers_question_sdk);
        mHelpDialog.setCanceledOnTouchOutside(true);

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.zm_rc_float_view_sdk, this);
...
//                }
    ...
    private void showKeyboard(boolean show) {
        ...
        if(show) {
            ...
            openSoftKeyboard(getContext(), mHiddenEditText);
        } else {
            closeSoftKeyboard(getContext(), mHiddenEditText);
        }
    }
    ...
    private void closeSoftKeyboard(@Nullable Context context, @Nullable View view) {
        if (context == null || view == null)
            return;
        InputMethodManager imm = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
        if(imm == null)
