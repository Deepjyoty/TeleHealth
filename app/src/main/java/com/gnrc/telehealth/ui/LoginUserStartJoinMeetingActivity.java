...
import com.gnrc.telehealth.initsdk.AuthConstants;
...
import com.gnrc.telehealth.startjoinmeeting.LoginUserStartMeetingHelper;
import com.gnrc.telehealth.startjoinmeeting.joinmeetingonly.JoinMeetingHelper;
    ...
    public void onMeetingStatusChanged(MeetingStatus meetingStatus, int errorCode,
        ...
        if (meetingStatus == MeetingStatus.MEETING_STATUS_CONNECTING) {
            if (ZoomMeetingUISettingHelper.useExternalVideoSource) {
                ZoomMeetingUISettingHelper.changeVideoSource(true, LoginUserStartJoinMeetingActivity.this);
            }
            showMeetingUi();
        }
        refreshUI();
