...
public class MeetingSettingActivity extends FragmentActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVideoSource.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ZoomMeetingUISettingHelper.changeVideoSource(isChecked, MeetingSettingActivity.this);
            }
        });
    ...
    void initInvite() {
        ...
        checkBox.setChecked((options.invite_options | InviteOptions.INVITE_DISABLE_ALL) == 0);
        checkBox.setOnCheckedChangeListener(listener);

        checkBox = findViewById(R.id.invite_enable_all);
        checkBox.setOnCheckedChangeListener(null);
        checkBox.setChecked((options.invite_options & InviteOptions.INVITE_ENABLE_ALL) == InviteOptions.INVITE_ENABLE_ALL);
        checkBox.setOnCheckedChangeListener(listener);

        checkBox = findViewById(R.id.invite_via_sms);
        checkBox.setOnCheckedChangeListener(null);
        checkBox.setChecked((options.invite_options & InviteOptions.INVITE_VIA_SMS) != 0);
        checkBox.setOnCheckedChangeListener(listener);

        checkBox = findViewById(R.id.invite_via_email);
        checkBox.setOnCheckedChangeListener(null);
        checkBox.setChecked((options.invite_options & InviteOptions.INVITE_VIA_EMAIL) != 0);
        checkBox.setOnCheckedChangeListener(listener);

        checkBox = findViewById(R.id.invite_copy_url);
        checkBox.setOnCheckedChangeListener(null);
        checkBox.setChecked((options.invite_options & InviteOptions.INVITE_COPY_URL) != 0);
        checkBox.setOnCheckedChangeListener(listener);
